...
def create_notebook(filename, cells_source):
...
output_dir = "c:/Users/Varun/Desktop/Main/3rd year/Sem 6/DL/Labs/DL Practicals"
...
"""
create_notebook(f"{output_dir}/Exp1_Perceptron.ipynb", [exp1])
...
"""
create_notebook(f"{output_dir}/Exp2_Backpropagation.ipynb", [exp2_cell1])
...
"""
create_notebook(f"{output_dir}/Exp3_CNN.ipynb", [exp3])
...
"""
create_notebook(f"{output_dir}/Exp4_RNN.ipynb", [exp4])
...
print(weights)
"""
create_notebook(f"{output_dir}/Exp5_SOM.ipynb", [exp5])
...
"""
create_notebook(f"{output_dir}/Exp6_PCA_Autoencoder.ipynb", [exp6])
...
for batch_idx, (data, _) in enumerate(train_loader):
    ...
    if batch_idx == 100: 
        ...
        break
"""
create_notebook(f"{output_dir}/Exp7_VAE.ipynb", [exp7])
...
"""
create_notebook(f"{output_dir}/Exp8_GAN.ipynb", [exp8])

print("All variations have been successfully generated into their respective notebooks.")
